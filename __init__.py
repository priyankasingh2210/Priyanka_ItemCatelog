...
CLIENT_ID = json.loads(open('/var/www/FlaskApp/Priyanka_ItemCatelog/client_secrets.json', 'r').read())['web']['client_id']  # noqa
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('/var/www/FlaskApp/Priyanka_ItemCatelog/client_secrets.json/client_secrets.json', scope='')
...
if __name__ == '__main__':
    app.secret_key = 'CkRmnNLssF4iLRK3Ct9XT4d9'
    app.debug = True
